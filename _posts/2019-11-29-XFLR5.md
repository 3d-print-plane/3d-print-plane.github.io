...
While there is a packaged version of XFLR5 in the package sources of Ubuntu & Debian this is REALLY old (Version 6.09.06 see [here](https://launchpad.net/ubuntu/+source/xflr5) or [here](https://launchpad.net/ubuntu/bionic/+package/xflr5) from [2013-12](https://sourceforge.net/p/xflr5/code/HEAD/tree/branches/) compared to current version [6.47 from 2019-07-07](https://sourceforge.net/projects/xflr5/files/6.47/) <sub><sub>FIXED LINK - NOT NECESSARILY CURRENT VERSION </sub></sub>) and had a few bugs bugging me. 
